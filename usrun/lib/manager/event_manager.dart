...
class EventManager {
  ...
  static Future<Response> getNewEventsPaged(int pageNum, int perPage) async {
    ...
    Response<dynamic> res = await Client.post('/event/getNewEvents',params);
  ...
  static Future<Response> getUserEventsPaged(int userId, int pageNum, int perPage) async {
    Map<String,dynamic> params = {
      'userId': userId,
      'offset': pageNum,
      'count': perPage
    ...
    Response<dynamic> res = await Client.post('/event/getUserEvents',params);
  ...
  static Future<Response> getEventAthlete(int eventId, int offset, int count) async {
    Map<String,dynamic> params = {
      'eventId': eventId,
      'offset': offset,
      'count': count,
  ...
  static Future<Response> getEventTeam(int eventId, int offset, int count) async {
    Map<String,dynamic> params = {
      'eventId': eventId,
      'offset': offset,
      'count': count,
  ...
  static Future<Response> getEventSponsor(int organizationId) async {
    ...
    EventOrganization sponsors = MapperObject.create<EventOrganization>(res.object);
  ...
  static Future<Response> leaveEvent(int eventId, int userId) async {
    Map<String, dynamic> params = {
      'eventId': eventId,
      'userId': userId,
    };
  ...
  static Future<Response> getEventLeaderboard(int eventId, bool isUserLeaderboard) async {
    Map<String, dynamic> params = {
      'eventId': eventId,
    };
  ...
  static Future<Response> findEventByName(String searchString, int offset, int count) async {
    Map<String, dynamic> params = {
      'searchString': searchString,
      'offset': offset,
      'count': count,
    };
    Response<dynamic> res = await Client.post('/event/findEventByName', params);
