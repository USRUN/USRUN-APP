...
class _DropdownMenuRouteLayout<T> extends SingleChildLayoutDelegate {
  _DropdownMenuRouteLayout({
    ...
    @required this.maxHeightBox, // QuocTK
    @required this.itemRect, // QuocTK
  });
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    ...
    // QuocTK
    // Unused anymore: final double width = math.min(constraints.maxWidth, buttonRect.width);
    double width1 = itemRect.right - itemRect.left;
  ...
  Offset getPositionForChild(Size size, Size childSize) {
    // QUOCTK
    return Offset(itemRect.left, itemRect.top + moreSpacing);
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
    ...
    return LayoutBuilder(
      ...
      return _DropdownRoutePage<T>(
        ...
        theme: theme,
        style: style,
        maxHeightBox: maxHeightBox, // QuocTK
        itemRect: itemRect, // QuocTK
      );
    });
  }
...
class _DropdownButtonState<T> extends State<DropdownButton<T>>
  ...
  void _handleTap() {
    ...
    _dropdownRoute = _DropdownRoute<T>(
      items: widget.items,
      maxHeightBox: widget.maxHeightBox, // QuocTK
      itemRect: itemRect, // QuocTK
