...
class _DateTimePickerWidgetState extends State<DateTimePickerWidget> {
  ...
  Widget _renderDatePickerWidget() {
    ...
    Widget dayPickerColumn = _renderDatePickerColumnComponent(
        ...
        itemBuilder: (BuildContext context, int index) {
          return _renderDayPickerItemComponent(
              _dayRange.first + index, dayFormat);
        });
  ...
  Widget _renderDayPickerItemComponent(int value, String format) {
    ...
    return Container(
      ...
      child: Text(
        ...
        style:
            widget.pickerTheme.itemTextStyle ?? _myTextStyle,
      ),
    );
  }
  ...
  Widget _renderDatePickerItemComponent(int value, String format) {
    TextStyle _myTextStyle;
    if ((format.contains('H') && _currHour == value) ||
        (format.contains('m') && _currMinute == value) ||
        (format.contains('s') && _currSecond == value)) {
      _myTextStyle = TextStyle(
        color: R.colors.majorOrange,
        fontSize: R.appRatio.appFontSize18,
      );
    ...
    return Container(
      ...
      child: Text(
        ...
        style: widget.pickerTheme.itemTextStyle ?? _myTextStyle,
      ),
    );
  }
