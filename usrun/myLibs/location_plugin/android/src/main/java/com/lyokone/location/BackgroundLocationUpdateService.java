...
public class BackgroundLocationUpdateService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    */
    ...
    private final String TAG = "USRUN";
    private final String TAG_LOCATION = "USRUN_BG_LOCATION";
    ...
    private void StartForeground() {
        ...
        builder.setContentTitle("Usrun is tracking your run");
        builder.setContentText("Touch for more information or to stop the app");
    ...
    public void onLocationChanged(Location location) {
        Log.d(TAG_LOCATION, "Location Changed Latitude : " + location.getLatitude() + "\tLongitude : " + location.getLongitude());
        ...
        if (latitude.equalsIgnoreCase("0.0") && longitude.equalsIgnoreCase("0.0")) {
            ...
            Log.d(TAG_LOCATION, "Latitude : " + location.getLatitude() + "\tLongitude : " + location.getLongitude());
        }
    }
    ...
    protected synchronized void buildGoogleApiClient() {
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                Log.d("USRUN", "method onLocationResult");
